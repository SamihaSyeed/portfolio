        ...
        <div className='footer'>
            <div className='contact-form-columns'>
                ...
                <div style={{padding:"10px 0"}}>
                    <div>Tel: +91 9003087275</div>
                    <div>Email: saranyav26112003@gmail.com</div>
                </div>
                <div style={{padding:"10px 0"}}>
                    <div className="media-icons">
                        ...
                        <Link to="https://www.linkedin.com/in/samiha-syeed/"><img src="https://static.wixstatic.com/media/16c1c1_3b7ccd6d4ac84813a5d3198ef8ebcf23~mv2.png/v1/fill/w_18,h_18,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/16c1c1_3b7ccd6d4ac84813a5d3198ef8ebcf23~mv2.png" alt="linkedin" /></Link>
                    </div>
                </div>
